...
#   - Extinction (or extinction coefficient) is defined as the ratio of maximum to minimum transmission of a beam of light that passes through a polarization optical train. extinction coefficient in units of  M<sup>-1</sup> cm<sup>-1</sup>, at 280 nm measured in water.
# 
# - Theoretical pI
...
print(f'# Total number of atom in {target_name} is {getMF(my_seq)[1]:->25}')
...
plt.title('Net charge prediction')
plt.show()
...
plt.pie(values, labels=names, autopct='%.1f%%', startangle=40, labeldistance=1.02,
